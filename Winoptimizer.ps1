#Install
    ...
    # Create Base Folder
        ...
        if(!(test-path $BaseFolder)){Write-host "." -NoNewline; mkdir $BaseFolder -ErrorAction SilentlyContinue | Out-Null }
...
do {
    ...
    Write-Host "`nOption: " -f Yellow -nonewline; ;
        ...
        Switch ($option) { 
            ...
            Default {  Write-Host "INVALID OPTION. TRY AGAIN.." -f red; Start-Sleep -s 2; Start-WinOptimizerUI } 
        }
}
